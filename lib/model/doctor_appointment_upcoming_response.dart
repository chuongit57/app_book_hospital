...
class DoctorAppointmentUpcomingResponse {
  final dynamic id;
  final Doctor doctor;
  ...
  DoctorAppointmentUpcomingResponse({
    required this.id,
  ...
  factory DoctorAppointmentUpcomingResponse.fromJson(Map<String, dynamic> json) {
    return DoctorAppointmentUpcomingResponse(
      id: json['id'],
