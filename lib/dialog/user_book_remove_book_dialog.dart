...
class UserBookRemoveBookDialog extends StatefulWidget {
  final Appointment appointment;
  final DoctorAppointment doctorAppointment;
  final Function(int) onSuccess;

  const UserBookRemoveBookDialog({super.key, required this.appointment, required this.onSuccess, required this.doctorAppointment});

  @override
  State<UserBookRemoveBookDialog> createState() => _UserBookRemoveBookDialogState();
}

class _UserBookRemoveBookDialogState extends State<UserBookRemoveBookDialog> {
